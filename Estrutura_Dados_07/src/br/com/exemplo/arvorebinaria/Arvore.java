...
public class Arvore {
    ...
    public int encontrarMenorValor(No node) {
    ...
    public int encontrarMaiorValor(No node) {
    ...
    public boolean saoIguais(Arvore outraArvore) {
        return saoIguaisRecursivo(this.raiz, outraArvore.raiz);
    }

    private boolean saoIguaisRecursivo(No node1, No node2) {
        ...
        return (node1.valor == node2.valor) &&
                saoIguaisRecursivo(node1.esquerda, node2.esquerda) &&
                saoIguaisRecursivo(node1.direita, node2.direita);
    }
}
